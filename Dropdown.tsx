...
const Dropdown: FunctionComponent<DropdownType> = ({
  ...
  return (
    <div
      className="absolute top-[457px] left-[177px] w-[420px] flex flex-col items-start justify-start gap-[8px_0px] max-w-full text-left text-sm text-gray-900 font-body-m"
      style={dropdownStyle}
    >
