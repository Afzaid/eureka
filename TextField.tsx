...
const TextField: FunctionComponent<TextFieldType> = ({
  ...
  return (
    <div className="self-stretch flex flex-col items-start justify-start gap-[4px_0px] text-left text-xs text-grey-700 font-body-m">
      ...
      <div className="self-stretch h-[42px] rounded box-border overflow-hidden shrink-0 flex flex-row items-center justify-start py-3 pr-2.5 pl-2 gap-[0px_197px] border-[1px] border-solid border-grey-500 mq450:gap-[0px_197px]">
        <input
